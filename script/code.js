...
let main = document.querySelector('[data-mainHeading]')
main.innerText = 'Javascript is my breakfast for today'
...
h4.innerHTML = 'Javascript is awesome and cool'
// 3.change the second subheading to 'I enjoy coding'
let subheading = document.querySelector('[data-secondHeading]')
subheading.innerText = 'I enjoy coding'
// 4. DO NOT USE QUERYSELCTOR: change the third subheading to 'My subconsious mind is my partner in success'
let thirdHeading = document.getElementsByClassName ('thirdHeading')[0]
thirdHeading.innerText = 'My subconsious mind is my partner in success'
// 5.DO NOT USE QUERY SELECTOR: change the forht subheading to 'My  body is an amazing healing mechanism'
let fourth = document.getElementsByTagName('h4')[3]
fourth.innerText = 'My body is amazing healing mechanism'
...
// 8.3 Attach  all the buttons with values to a single variable(This is will now make it/or return an array)
let btns = document.querySelectorAll('[value]')
// 8.4 Now create a function that will add the button to the input tag.
function append(textInput) { 
...
//  Equal = a => input.value = eval(input.value)
...
document.querySelector('[data-textset').getAttribute('data-textset') 
